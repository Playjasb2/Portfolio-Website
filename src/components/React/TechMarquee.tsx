...
const technologies = [
  ...
  { name: "TanStack", icon: TanStackIcon, color: "#FF4154" },
...
export default function TechMarquee() {
  return (
    <section className="py-10 border-y border-white/5 bg-surface/30 backdrop-blur-sm overflow-hidden whitespace-nowrap relative">
      ...
      {technologies.map((tech, index) => {
        ...
        return (
          <div key={index} className="flex items-center gap-4 group cursor-default">
            <span
              className="p-3 rounded-xl bg-white/5 text-zinc-400 group-hover:bg-white/10 transition-all duration-300"
              style={{
            ...
            >
              <Icon
                size={24}
                className="transition-colors duration-300 group-hover:drop-shadow-[0_0_8px_var(--glow-color)]"
                style={
                  {
            ...
            <span className="text-xl font-bold text-zinc-500 group-hover:text-zinc-200 transition-colors">
              {tech.name}
            </span>
          </div>
        );
